...
#crecimiento.show()
crecimiento.write_image("images/crecimiento.png")
...
Factor_Crecimiento.write_image("images/Factor_Crecimiento.png")
...
Confirmados_Barr.write_image("images/Confirmados_Barr.png")
...
Recuperados_Barr.write_image("images/Recuperados_Barr.png")
...
Muertes_Barr.write_image("images/Muertes_Barr.png")
...
pd.set_option('display.float_format', lambda x: '%.6f' % x)
Intervalos_Barr=pd.DataFrame(zip(Int_Conf,Int_Recu,Int_Muertos),
                               columns=["Int_Confirmados","Int_Recuperados", "Int_Muertes"])
Intervalos_Barr

"""##Métricas"""

Error_Barr=pd.DataFrame(zip(model_scores_Barr_Conf,model_scores_Barr_recu,model_scores_Barr_M),
                               columns=["RMSE_Confirmados","RMSE_Recuperados", "RMSE_Muertes"])
Error_Barr
...
Factor_Crecimiento.update_layout(title="Factor de crecimiento casos confirmados, recuperados y muertes",
                 xaxis_title="Fecha",yaxis_title="Factor de crecimiento",
                 legend=dict(x=0,y=-0.4,traceorder="normal"))
Factor_Crecimiento.write_image("images/Factor_Crecimiento_bog.png")
...
Confirmados_Bog.update_layout(title="Predicción casos confirmados modelo AR",
                 xaxis_title="Fecha",yaxis_title="Casos  confirmados",legend=dict(x=0,y=1,traceorder="normal"))
Confirmados_Bog.write_image("images/Confirmados_Bog.png")
...
Recuperados_Bog.update_layout(title="Predicción casos recuperados modelo AR",
                 xaxis_title="Fecha",yaxis_title="Casos  recuperados",legend=dict(x=0,y=1,traceorder="normal"))
Recuperados_Bog.write_image("images/Recuperados_Bog.png")
...
Muertes_Bog.update_layout(title="Predicción muertes modelo SARIMA",
                 xaxis_title="Fecha",yaxis_title="Muertes",legend=dict(x=0,y=1,traceorder="normal"))
Muertes_Bog.write_image("images/Muertes_Bog.png")
...
pd.set_option('display.float_format', lambda x: '%.6f' % x)
Predicciones_Bog=pd.DataFrame(zip(nuevo_dia,Prediccion_AR_Bog_Con,Prediccion_AR_Bog_recu,Prediccion_SARIMA_Bog_M ),
                               columns=["Fechas","Modelo AR Confirmados","Modelo AR Recuperados", "Modelo SARIMA Muertes"])
...
pd.set_option('display.float_format', lambda x: '%.6f' % x)
Intervalos_Bog=pd.DataFrame(zip(Int_Conf,Int_Recu,Int_Muertos),
                               columns=["Int_Confirmados","Int_Recuperados", "Int_Muertes"])
Intervalos_Bog

"""##Métricas"""

Error_Bog=pd.DataFrame(zip(model_scores_Bog_Conf,model_scores_Bog_recu,model_scores_Bog_M),
                               columns=["RMSE_Confirmados","RMSE_Recuperados", "RMSE_Muertes"])
Error_Bog
...
Muertes_Med.update_layout(title="Predicción muertes modelo SARIMA",
                 xaxis_title="Fecha",yaxis_title="Muertes",legend=dict(x=0,y=1,traceorder="normal"))
Muertes_Med.write_image("images/Muertes_Med.png")
...
pd.set_option('display.float_format', lambda x: '%.6f' % x)
Predicciones_Med=pd.DataFrame(zip(nuevo_dia,Prediccion_AR_Med_Con,Prediccion_AR_Med_recu,Prediccion_SARIMA_Med_M ),
                               columns=["Fechas","Modelo AR Confirmados","Modelo AR Recuperados", "Modelo SARIMA Muertes"])
...
pd.set_option('display.float_format', lambda x: '%.6f' % x)
Intervalos_Med=pd.DataFrame(zip(Int_Conf,Int_Recu,Int_Muertos),
                               columns=["Int_Confirmados","Int_Recuperados", "Int_Muertes"])
Intervalos_Med

"""##Métricas"""

Error_Med=pd.DataFrame(zip(model_scores_Med_Conf,model_scores_Med_recu,model_scores_Med_M),
                               columns=["RMSE_Confirmados","RMSE_Recuperados", "RMSE_Muertes"])
Error_Med
...
crecimiento.update_layout(title="Crecimiento semanal por tipo de casos en Cali",
                 xaxis_title="Semana",yaxis_title="Número de casos",legend=dict(x=0,y=1,traceorder="normal"))
crecimiento.write_image("images/crecimiento_cal.png")
...
Factor_Crecimiento.update_layout(title="Factor de crecimiento casos confirmados, recuperados y muertes",
                 xaxis_title="Fecha",yaxis_title="Factor de crecimiento",
                 legend=dict(x=0,y=-0.4,traceorder="normal"))
Factor_Crecimiento.write_image("images/Factor_Crecimiento_cal.png")
...
Confirmados_Cal.update_layout(title="Predicción casos confirmados modelo AR",
                 xaxis_title="Fecha",yaxis_title="Casos  confirmados",legend=dict(x=0,y=1,traceorder="normal"))
Confirmados_Cal.write_image("images/Confirmados_Cal.png")
...
##Selección
model_ar_Cal_recu= auto_arima(model_train_Cal_recu["Recuperados"],trace=True, error_action='ignore', start_p=0,start_q=0,max_p=7,max_q=0,
                   suppress_warnings=True,stepwise=False,seasonal=False)
...
Recuperados_Cal.update_layout(title="Predicción casos recuperados modelo AR",
                 xaxis_title="Fecha",yaxis_title="Casos  recuperados",legend=dict(x=0,y=1,traceorder="normal"))
Recuperados_Cal.write_image("images/Recuperados_Cal.png")
...
Muertes_Cal.update_layout(title="Predicción muertes modelo SARIMA",
                 xaxis_title="Fecha",yaxis_title="Muertes",legend=dict(x=0,y=1,traceorder="normal"))
Muertes_Cal.write_image("images/Muertes_Cal.png")
...
pd.set_option('display.float_format', lambda x: '%.6f' % x)
Predicciones_Cal=pd.DataFrame(zip(nuevo_dia,Prediccion_AR_Cal_Con,Prediccion_AR_Cal_recu,Prediccion_SARIMA_Cal_M ),
                               columns=["Fechas","Modelo AR Confirmados","Modelo AR Recuperados", "Modelo SARIMA Muertes"])
...
pd.set_option('display.float_format', lambda x: '%.6f' % x)
Intervalos_Cal=pd.DataFrame(zip(Int_Conf,Int_Recu,Int_Muertos),
                               columns=["Int_Confirmados","Int_Recuperados", "Int_Muertes"])
Intervalos_Cal

"""##Métricas"""

Error_Cal=pd.DataFrame(zip(model_scores_Cal_Conf,model_scores_Cal_recu,model_scores_Cal_M),
                               columns=["RMSE_Confirmados","RMSE_Recuperados", "RMSE_Muertes"])
Error_Cal
...
crecimiento.update_layout(title="Crecimiento semanal por tipo de casos en Cartagena de Indias",
                 xaxis_title="Semana",yaxis_title="Número de casos",legend=dict(x=0,y=1,traceorder="normal"))
crecimiento.write_image("images/crecimiento_cart.png")
...
Factor_Crecimiento.update_layout(title="Factor de crecimiento casos confirmados, recuperados y muertes",
                 xaxis_title="Fecha",yaxis_title="Factor de crecimiento",
                 legend=dict(x=0,y=-0.4,traceorder="normal"))
Factor_Crecimiento.write_image("images/Factor_Crecimiento_cart.png")
...
Confirmados_Cart.update_layout(title="Predicción casos confirmados modelo AR",
                 xaxis_title="Fecha",yaxis_title="Casos  confirmados",legend=dict(x=0,y=1,traceorder="normal"))
Confirmados_Cart.write_image("images/Confirmados_Cart.png")
...
Recuperados_Cart.update_layout(title="Predicción casos recuperados modelo AR",
                 xaxis_title="Fecha",yaxis_title="Casos  recuperados",legend=dict(x=0,y=1,traceorder="normal"))
Recuperados_Cart.write_image("images/Recuperados_Cart.png")
...
Muertes_Cart.update_layout(title="Predicción muertes modelo SARIMA",
                 xaxis_title="Fecha",yaxis_title="Muertes",legend=dict(x=0,y=1,traceorder="normal"))
Muertes_Cart.write_image("images/Muertes_Cart.png")
...
pd.set_option('display.float_format', lambda x: '%.6f' % x)
Predicciones_Cart=pd.DataFrame(zip(nuevo_dia,Prediccion_AR_Cart_Con,Prediccion_AR_Cart_recu,Prediccion_SARIMA_Cart_M ),
                               columns=["Fechas","Modelo AR Confirmados","Modelo AR Recuperados", "Modelo SARIMA Muertes"])
...
pd.set_option('display.float_format', lambda x: '%.6f' % x)
Intervalos_Cart=pd.DataFrame(zip(Int_Conf,Int_Recu,Int_Muertos),
                               columns=["Int_Confirmados","Int_Recuperados", "Int_Muertes"])
Intervalos_Cart

"""##Métricas"""

Error_Cart=pd.DataFrame(zip(model_scores_Cart_Conf,model_scores_Cart_recu,model_scores_Cart_M),
                               columns=["RMSE_Confirmados","RMSE_Recuperados", "RMSE_Muertes"])
Error_Cart